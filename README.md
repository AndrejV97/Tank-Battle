...
jstart - Ова е почетниот бројач за теренот, при првиот повик ова би било 4(3+1), (бидејќи имаме вкупно 4 зида кои го заобиколуваат целиот левел, и тие се неуништливи, и затоа за нив немора споредба, а додаваме уште 1 на бројачот за да се избегне проверка на теренот од предходно).
